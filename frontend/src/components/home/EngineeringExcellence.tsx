    ...
    <section className="py-24 md:py-32 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="We hold ourselves to the highest standards of software engineering. Every system we build is designed for reliability, performance, and maintainability."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {ENGINEERING_PRINCIPLES.map((principle, i) => (
            <motion.div
              ...
              className="group"
            >
              <div className="glass p-6 md:p-8 h-full transition-all duration-300 group-hover:border-indigo-500/30 group-hover:shadow-lg group-hover:shadow-indigo-500/5">
